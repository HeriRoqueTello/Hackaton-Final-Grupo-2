<template>
  <section
    ...
    <div class="w-full">
      <div class="mt-[32px]">
        <p class="text-xs text-center text-[#222222] mb-[15px]">Puedes registrarte con:</p>
        <div class="w-full flex justify-center gap-x-[17px]">
          <button class="border-solid border-[1px] border-[#8b9099] rounded-[5px]">
        ...
        <p class="text-xs text-center text-[#222222] mt-[25px]">También puedes registrarte con tu correo</p>
      </div>

      <form class="mt-[40px]">
        <div
          class="relative w-full border-solid border-[1px] border-[#8b9099] rounded-[5px] pt-[20px] px-[15px] pb-[16px] mb-[20px]">
          <input type="text" name="nameLastname" id="nameLastname"
            class="w-full text-xs font-bold text-[#222222] outline-0" autocomplete="off" required>
          <label for="nameLastname">Nombres y apellidos</label>
        </div>
        <div
          class="relative w-full border-solid border-[1px] border-[#8b9099] rounded-[5px] pt-[20px] px-[15px] pb-[16px] mb-[20px]">
        ...
        <div v-if="showPassword02"
          class="relative w-full border-solid border-[1px] border-[#8b9099] rounded-[5px] pt-[20px] px-[15px] pb-[16px] mb-[20px] flex justify-between items-center">
          <input type="text" name="password02" id="password02" class="w-full text-xs font-bold text-[#222222] outline-0"
            autocomplete="off" required v-model="valuePassword02">
          <label for="password02">Repite contraseña</label>
          <img class="w-[16px] h-[11px] cursor-pointer" src="/icons/show-icon.png" alt="Show Password Icon"
            @click="showPassword02 = false">
        </div>
        <div v-else
          class="relative w-full border-solid border-[1px] border-[#8b9099] rounded-[5px] pt-[20px] px-[15px] pb-[16px] mb-[20px] flex justify-between items-center">
          <input type="password" name="password02" id="password02"
            class="w-full text-xs font-bold text-[#222222] outline-0" autocomplete="off" required
            v-model="valuePassword02">
          <label for="password02">Repite contraseña</label>
          <img class="w-[16px] h-[11px] cursor-pointer" src="/icons/show-icon.png" alt="Show Password Icon"
            @click="showPassword02 = true">
        </div>
        <div class="flex items-center">
          <input type="checkbox" name="accept" id="accept" class="my-checkbox" required><label for="accept"
            class="text-xs text-[#222222] ml-[10px]">Acepto <a class="font-bold underline">Términos y
              Condiciones</a></label>
        </div>
        <button
          class="mt-[30px] mb-[60px] bg-[#5640FF] w-full rounded-[10px] py-[18px] text-sm font-bold text-[#ffffff]">Registrarse</button>
      </form>
    </div>
  </section>
</template>
